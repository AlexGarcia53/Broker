...
/**
 * Clase encargada del envío de una solicitud del tipo editar comentario.
...
public class SolicitudEditarComentario implements IEstrategia {
     ...
     * también se encarga de notificar la edición de un comentario mediante el observable, esto en caso de que 
