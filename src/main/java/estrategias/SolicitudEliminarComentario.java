...
/**
 * Clase encargada del envío de una solicitud del tipo eliminar comentario.
 * @author Equipo Broker.
 */
public class SolicitudEliminarComentario implements IEstrategia {
    /**
     ...
     * también se encarga de notificar la eliminación de un comentario mediante el observable, esto en caso de que 
