...
/**
 * Clase encargada del envío de una solicitud del tipo consultar publicaciones mediante el hashtag.
 * @author Equipo Broker.
 */
public class SolicitudConsultarPublicacionesHashtag implements IEstrategia{
    /**
