...
/**
 * Clase encargada del envío de una solicitud del tipo registrar comentario.
 * @author Equipo Broker.
 */
public class SolicitudRegistrarComentario implements IEstrategia {
    /**
     ...
     * también se encarga de notificar el registro de un comentario mediante el observable, esto en caso de que 
